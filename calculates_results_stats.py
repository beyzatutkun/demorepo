...
def calculates_results_stats(results_dic):
    ...
    """        
    results_stats_dic = dict() #create an empyt dictionary
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            ...
            if results_dic[key][4] == 0:
                ...
                results_stats_dic['n_correct_notdogs'] = results_stats_dic['n_correct_notdogs'] 
            
    results_stats_dic['n_images'] = len(results_dic) #D
